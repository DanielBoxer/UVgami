...
class SingletonUpdater:
    ...
    def __init__(self):
        ...
        package = str(root_path.stem)
        self._addon = package.lower()
        self._addon_package = package  # Must not change.
        self._updater_path = str(file_path.parent / (self._addon + "_updater"))
