...
def get_user_preferences(context=None):
    ...
    if hasattr(context, "user_preferences"):
        prefs = context.user_preferences.addons.get(updater._addon_package, None)
    elif hasattr(context, "preferences"):
        prefs = context.preferences.addons.get(updater._addon_package, None)
    if prefs:
...
def register(bl_info):
    ...
    updater.website = "https://github.com/DanielBoxer/UVgami"
